...
def test_init_db(db_handler):
    ...
    with db_handler._managed_connection() as conn:
        cursor = conn.cursor()
        cursor.execute("SELECT name FROM sqlite_master WHERE type='table' AND name='flight_reports'")
...
def test_report_exists(db_handler):
    ...
    report_data = {
        "id": "test_id_2", "timestamp": timestamp, "source": "test.json", "raw_event_text": raw_text,
        "summary": "S", "category": "C", "severity": "S", "recommendation": "R", "model_meta": "{}"
    }
...
def test_get_stats_by_category(db_handler):
    ...
    reports = [
        {"id": "1", "timestamp": "1", "source": "s", "raw_event_text": "t1", "summary": "s", "category": "Avionics", "severity": "low", "recommendation": "r", "model_meta": "{}"},
        {"id": "2", "timestamp": "2", "source": "s", "raw_event_text": "t2", "summary": "s", "category": "Avionics", "severity": "low", "recommendation": "r", "model_meta": "{}"},
        {"id": "3", "timestamp": "3", "source": "s", "raw_event_text": "t3", "summary": "s", "category": "Mechanical", "severity": "high", "recommendation": "r", "model_meta": "{}"}
    ]
    for r in reports:
...
def test_list_reports_by_severity(db_handler):
    ...
    reports = [
        {"id": "1", "timestamp": "1", "raw_event_text": "t1", "category": "C1", "severity": "low", "summary": "S1", "recommendation": "R1", "source": "s", "model_meta": "{}"},
        {"id": "2", "timestamp": "2", "raw_event_text": "t2", "category": "C2", "severity": "high", "summary": "S2", "recommendation": "R2", "source": "s", "model_meta": "{}"},
        {"id": "3", "timestamp": "3", "raw_event_text": "t3", "category": "C3", "severity": "low", "summary": "S3", "recommendation": "R3", "source": "s", "model_meta": "{}"}
    ]
    for r in reports:
        db_handler.add_event(r)
